...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtc_pak' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xp/xpgit/yubot/src/rtc_pak/${idir}'.  Ask the maintainer 'xp <xp@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/xp/xpgit/yubot/devel/lib;/home/xp/xpgit/yubot/devel/lib;/opt/ros/indigo/lib)
