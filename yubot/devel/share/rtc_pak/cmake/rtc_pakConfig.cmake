...
if("TRUE" STREQUAL "TRUE")
  set(rtc_pak_SOURCE_PREFIX /home/xp/git/yubot/src/rtc_pak)
  set(rtc_pak_DEVEL_PREFIX /home/xp/git/yubot/devel)
  set(rtc_pak_INSTALL_PREFIX "")
  set(rtc_pak_PREFIX ${rtc_pak_DEVEL_PREFIX})
else()
  set(rtc_pak_SOURCE_PREFIX "")
  set(rtc_pak_DEVEL_PREFIX "")
  set(rtc_pak_INSTALL_PREFIX /home/xp/git/yubot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rtc_pak' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/xp/git/yubot/src/rtc_pak/${idir}'.  Ask the maintainer 'xp <xp@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/xp/git/yubot/devel/lib;/home/xp/git/yubot/devel/lib;/opt/ros/indigo/lib)
